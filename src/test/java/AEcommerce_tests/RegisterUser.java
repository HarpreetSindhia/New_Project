...
public class RegisterUser {
	...
	public void registerUser()
	{
		...
		driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("Anaahadbir Sindhia");
		driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("anuengsindhia@gmail.com");
		...
		dropDown2.selectByVisibleText("2023");
