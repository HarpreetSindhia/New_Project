...
public class RegisterUser2 {
	...
	public void registerUser()
	{
		...
		driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("Yuvaan Sindhia");
		driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("yuvsindhia@gmail.com");
		...
		driver.findElement(By.xpath("//input[@id='password']")).sendKeys("sindhiaYuv55");
		...
		driver.findElement(By.xpath("//input[@id='first_name']")).sendKeys("Yuvaan");
		driver.findElement(By.xpath("//input[@id='last_name']")).sendKeys("Sindhia");
		driver.findElement(By.xpath("//input[@id='company']")).sendKeys("Porsche");
